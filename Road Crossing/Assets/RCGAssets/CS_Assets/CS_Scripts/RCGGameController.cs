	...
	public class RCGGameController : MonoBehaviour
	{
		...
		IEnumerator GameOver(float delay)
		{
			...
			if( gameOverCanvas )
			{
				...
				gameOverCanvas.Find("TextScore").GetComponent<Text>().text =score.ToString();
				...
				gameOverCanvas.Find("TextHighScore").GetComponent<Text>().text =highScore.ToString();
			}
